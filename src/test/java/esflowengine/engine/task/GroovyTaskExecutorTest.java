...
//		ScriptEngine taskJob = mgr.getEngineByName("groovy");
//
...
//		taskJob.eval("Object _bindings = bindings; for(row in rows) {'hello:'+name + ' row.name='+row.name; if(_bindings.hasNext()) _bindings.next()}", bindings);
